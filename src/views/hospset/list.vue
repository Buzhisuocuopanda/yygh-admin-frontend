<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item>
        <el-input  v-model="searchObj.hosname" placeholder="商家名称"/>
      </el-form-item>
      <el-form-item>
        <el-input v-model="searchObj.hoscode" placeholder="商家编号"/>
      </el-form-item>
    ...
    <el-table :data="list" stripe style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="hosname" label="商家名称"/>
      <el-table-column prop="hoscode" label="商家编号"/>
...
export default {
  ...
  methods: {
    ...
    deleteRow(id) {
        this.$confirm('此操作将永久删除该商家设置信息, 是否继续?', '提示', {
